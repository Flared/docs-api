...
Moreover, each global search response includes the `X-Flare-Global-Searches-Remaining` header, indicating the number of API calls remaining in your monthly allocation.
