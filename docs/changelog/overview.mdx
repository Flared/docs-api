...
<Update label="2025-01" description="API - January 2025">
  Modified the get-activities endpoint to accept the UID as a query parameter instead of as path parameters. This avoids confusion that some users had when using uids that have multiple slashes. The old endpoint with path parameters was kept for backwards compatibility.
